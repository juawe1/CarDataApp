...
namespace Bmw.Dashboard.Core.ViewModels
{
    public class SettingsViewModel : ObservableObject
    {
        ...
        public SettingsViewModel(ISettingsService settingsService, IBmwApiService api, IPasswordVaultService passwordVaultService)
        {
        ...
        public async Task AuthorizeAsync()
        {
            try
            {
                var pkce = Bmw.Dashboard.Core.Helpers.PkceHelper.Generate();
